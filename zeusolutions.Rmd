...
From the model above, we can see gender has an effect on whether or not a employee is promoted. It is evidently the case that woman are 49% less likely to be promoted than men.  Therefore, we can say that the evidence shows the promotion processes at Black Saber are unfair. 
