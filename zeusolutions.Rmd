...
final_hires <- final_hires %>%  left_join(phase3_applicants, by = "applicant_id")
```


## (Hiring Question) What factors affect AI scoring of leadership and speaking skills in the second phase of the application process?
...
**Justin Lee**. Justin is a junior consultant with Zeusolutions. He specializes in data analytics. Justin earned his Bachelor of Science, Majoring in Statistics and Mathematics from the Unviversity of Toronto in 2021. 
